...
\restrict TJZENAuMUETxoN41c8DpywrgUWGtSgXEClPWkBgyylUaPlhAt5pRsH72Br4q9Wo
...
ALTER TABLE IF EXISTS ONLY public.weekly_training_plans DROP CONSTRAINT IF EXISTS "weekly_training_plans_userId_fkey";
ALTER TABLE IF EXISTS ONLY public.weekly_training_exercises DROP CONSTRAINT IF EXISTS "weekly_training_exercises_planId_fkey";
ALTER TABLE IF EXISTS ONLY public.weekly_training_exercises DROP CONSTRAINT IF EXISTS "weekly_training_exercises_exerciseId_fkey";
ALTER TABLE IF EXISTS ONLY public.user_states DROP CONSTRAINT IF EXISTS "user_states_userId_fkey";
ALTER TABLE IF EXISTS ONLY public.user_profiles DROP CONSTRAINT IF EXISTS "user_profiles_userId_fkey";
ALTER TABLE IF EXISTS ONLY public.training_exercise_executions DROP CONSTRAINT IF EXISTS "training_exercise_executions_exerciseId_fkey";
ALTER TABLE IF EXISTS ONLY public.training_exercise_executions DROP CONSTRAINT IF EXISTS "training_exercise_executions_executionId_fkey";
ALTER TABLE IF EXISTS ONLY public.training_day_executions DROP CONSTRAINT IF EXISTS "training_day_executions_userId_fkey";
ALTER TABLE IF EXISTS ONLY public.push_subscriptions DROP CONSTRAINT IF EXISTS "push_subscriptions_userId_fkey";
ALTER TABLE IF EXISTS ONLY public.least_favorite_exercises DROP CONSTRAINT IF EXISTS "least_favorite_exercises_userId_fkey";
ALTER TABLE IF EXISTS ONLY public.least_favorite_exercises DROP CONSTRAINT IF EXISTS "least_favorite_exercises_exerciseId_fkey";
ALTER TABLE IF EXISTS ONLY public.favorite_exercises DROP CONSTRAINT IF EXISTS "favorite_exercises_userId_fkey";
ALTER TABLE IF EXISTS ONLY public.favorite_exercises DROP CONSTRAINT IF EXISTS "favorite_exercises_exerciseId_fkey";
DROP INDEX IF EXISTS public."weekly_training_plans_userId_week_key";
DROP INDEX IF EXISTS public."weekly_training_plans_userId_idx";
DROP INDEX IF EXISTS public."weekly_training_exercises_planId_dayOfWeek_orderInDay_key";
DROP INDEX IF EXISTS public."weekly_training_exercises_planId_dayOfWeek_idx";
DROP INDEX IF EXISTS public.users_login_key;
DROP INDEX IF EXISTS public.users_email_key;
DROP INDEX IF EXISTS public."user_states_userId_key";
DROP INDEX IF EXISTS public."user_states_userId_idx";
DROP INDEX IF EXISTS public."user_profiles_userId_key";
DROP INDEX IF EXISTS public."user_profiles_userId_idx";
DROP INDEX IF EXISTS public."training_exercise_executions_executionId_orderInDay_idx";
DROP INDEX IF EXISTS public."training_day_executions_week_dayOfWeek_idx";
DROP INDEX IF EXISTS public."training_day_executions_userId_week_dayOfWeek_startTime_key";
DROP INDEX IF EXISTS public."training_day_executions_userId_startTime_idx";
DROP INDEX IF EXISTS public."push_subscriptions_userId_idx";
DROP INDEX IF EXISTS public.push_subscriptions_endpoint_key;
DROP INDEX IF EXISTS public."least_favorite_exercises_userId_idx";
DROP INDEX IF EXISTS public."least_favorite_exercises_userId_exerciseId_key";
DROP INDEX IF EXISTS public."favorite_exercises_userId_idx";
DROP INDEX IF EXISTS public."favorite_exercises_userId_exerciseId_key";
DROP INDEX IF EXISTS public."exercises_primaryMuscleGroup_idx";
DROP INDEX IF EXISTS public.exercises_name_idx;
ALTER TABLE IF EXISTS ONLY public.weekly_training_plans DROP CONSTRAINT IF EXISTS weekly_training_plans_pkey;
ALTER TABLE IF EXISTS ONLY public.weekly_training_exercises DROP CONSTRAINT IF EXISTS weekly_training_exercises_pkey;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_pkey;
ALTER TABLE IF EXISTS ONLY public.user_states DROP CONSTRAINT IF EXISTS user_states_pkey;
ALTER TABLE IF EXISTS ONLY public.user_profiles DROP CONSTRAINT IF EXISTS user_profiles_pkey;
ALTER TABLE IF EXISTS ONLY public.training_exercise_executions DROP CONSTRAINT IF EXISTS training_exercise_executions_pkey;
ALTER TABLE IF EXISTS ONLY public.training_day_executions DROP CONSTRAINT IF EXISTS training_day_executions_pkey;
ALTER TABLE IF EXISTS ONLY public.push_subscriptions DROP CONSTRAINT IF EXISTS push_subscriptions_pkey;
ALTER TABLE IF EXISTS ONLY public.least_favorite_exercises DROP CONSTRAINT IF EXISTS least_favorite_exercises_pkey;
ALTER TABLE IF EXISTS ONLY public.favorite_exercises DROP CONSTRAINT IF EXISTS favorite_exercises_pkey;
...
DROP TABLE IF EXISTS public.weekly_training_plans;
DROP TABLE IF EXISTS public.weekly_training_exercises;
DROP TABLE IF EXISTS public.users;
DROP TABLE IF EXISTS public.user_states;
DROP TABLE IF EXISTS public.user_profiles;
DROP TABLE IF EXISTS public.training_exercise_executions;
DROP TABLE IF EXISTS public.training_day_executions;
DROP SEQUENCE IF EXISTS public.push_subscriptions_id_seq;
DROP TABLE IF EXISTS public.push_subscriptions;
DROP TABLE IF EXISTS public.least_favorite_exercises;
DROP TABLE IF EXISTS public.favorite_exercises;
DROP TABLE IF EXISTS public.exercises;
DROP TABLE IF EXISTS public._prisma_migrations;
DROP TYPE IF EXISTS public."Wellbeing";
DROP TYPE IF EXISTS public."TrainingSplit";
DROP TYPE IF EXISTS public."TrainingFocus";
DROP TYPE IF EXISTS public."Role";
DROP TYPE IF EXISTS public."PrimaryMuscleGroup";
DROP TYPE IF EXISTS public."MuscleGroup";
DROP TYPE IF EXISTS public."MovementPattern";
DROP TYPE IF EXISTS public."Lifestyle";
...
\unrestrict TJZENAuMUETxoN41c8DpywrgUWGtSgXEClPWkBgyylUaPlhAt5pRsH72Br4q9Wo
