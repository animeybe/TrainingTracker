...
\restrict swSHGTIXANVnecfeCfgphxTVxFZEfUZIVRvzStVtGcSkJBpfFoXdOoV6HQP08ZR
...
ALTER TABLE ONLY public.weekly_training_plans DROP CONSTRAINT "weekly_training_plans_userId_fkey";
ALTER TABLE ONLY public.weekly_training_exercises DROP CONSTRAINT "weekly_training_exercises_planId_fkey";
ALTER TABLE ONLY public.weekly_training_exercises DROP CONSTRAINT "weekly_training_exercises_exerciseId_fkey";
ALTER TABLE ONLY public.user_states DROP CONSTRAINT "user_states_userId_fkey";
ALTER TABLE ONLY public.user_profiles DROP CONSTRAINT "user_profiles_userId_fkey";
ALTER TABLE ONLY public.training_exercise_executions DROP CONSTRAINT "training_exercise_executions_exerciseId_fkey";
ALTER TABLE ONLY public.training_exercise_executions DROP CONSTRAINT "training_exercise_executions_executionId_fkey";
ALTER TABLE ONLY public.training_day_executions DROP CONSTRAINT "training_day_executions_userId_fkey";
ALTER TABLE ONLY public.push_subscriptions DROP CONSTRAINT "push_subscriptions_userId_fkey";
ALTER TABLE ONLY public.least_favorite_exercises DROP CONSTRAINT "least_favorite_exercises_userId_fkey";
ALTER TABLE ONLY public.least_favorite_exercises DROP CONSTRAINT "least_favorite_exercises_exerciseId_fkey";
ALTER TABLE ONLY public.favorite_exercises DROP CONSTRAINT "favorite_exercises_userId_fkey";
ALTER TABLE ONLY public.favorite_exercises DROP CONSTRAINT "favorite_exercises_exerciseId_fkey";
DROP INDEX public."weekly_training_plans_userId_week_key";
DROP INDEX public."weekly_training_plans_userId_idx";
DROP INDEX public."weekly_training_exercises_planId_dayOfWeek_orderInDay_key";
DROP INDEX public."weekly_training_exercises_planId_dayOfWeek_idx";
DROP INDEX public.users_login_key;
DROP INDEX public.users_email_key;
DROP INDEX public."user_states_userId_key";
DROP INDEX public."user_states_userId_idx";
DROP INDEX public."user_profiles_userId_key";
DROP INDEX public."user_profiles_userId_idx";
DROP INDEX public."training_exercise_executions_executionId_orderInDay_idx";
DROP INDEX public."training_day_executions_week_dayOfWeek_idx";
DROP INDEX public."training_day_executions_userId_week_dayOfWeek_startTime_key";
DROP INDEX public."training_day_executions_userId_startTime_idx";
DROP INDEX public."push_subscriptions_userId_idx";
DROP INDEX public.push_subscriptions_endpoint_key;
DROP INDEX public."least_favorite_exercises_userId_idx";
DROP INDEX public."least_favorite_exercises_userId_exerciseId_key";
DROP INDEX public."favorite_exercises_userId_idx";
DROP INDEX public."favorite_exercises_userId_exerciseId_key";
DROP INDEX public."exercises_primaryMuscleGroup_idx";
DROP INDEX public.exercises_name_idx;
ALTER TABLE ONLY public.weekly_training_plans DROP CONSTRAINT weekly_training_plans_pkey;
ALTER TABLE ONLY public.weekly_training_exercises DROP CONSTRAINT weekly_training_exercises_pkey;
ALTER TABLE ONLY public.users DROP CONSTRAINT users_pkey;
ALTER TABLE ONLY public.user_states DROP CONSTRAINT user_states_pkey;
ALTER TABLE ONLY public.user_profiles DROP CONSTRAINT user_profiles_pkey;
ALTER TABLE ONLY public.training_exercise_executions DROP CONSTRAINT training_exercise_executions_pkey;
ALTER TABLE ONLY public.training_day_executions DROP CONSTRAINT training_day_executions_pkey;
ALTER TABLE ONLY public.push_subscriptions DROP CONSTRAINT push_subscriptions_pkey;
ALTER TABLE ONLY public.least_favorite_exercises DROP CONSTRAINT least_favorite_exercises_pkey;
ALTER TABLE ONLY public.favorite_exercises DROP CONSTRAINT favorite_exercises_pkey;
...
ALTER TABLE public.push_subscriptions ALTER COLUMN id DROP DEFAULT;
DROP TABLE public.weekly_training_plans;
DROP TABLE public.weekly_training_exercises;
DROP TABLE public.users;
DROP TABLE public.user_states;
DROP TABLE public.user_profiles;
DROP TABLE public.training_exercise_executions;
DROP TABLE public.training_day_executions;
DROP SEQUENCE public.push_subscriptions_id_seq;
DROP TABLE public.push_subscriptions;
DROP TABLE public.least_favorite_exercises;
DROP TABLE public.favorite_exercises;
DROP TABLE public.exercises;
DROP TABLE public._prisma_migrations;
DROP TYPE public."Wellbeing";
DROP TYPE public."TrainingSplit";
DROP TYPE public."TrainingFocus";
DROP TYPE public."Role";
DROP TYPE public."PrimaryMuscleGroup";
DROP TYPE public."MuscleGroup";
DROP TYPE public."MovementPattern";
DROP TYPE public."Lifestyle";
...
\unrestrict swSHGTIXANVnecfeCfgphxTVxFZEfUZIVRvzStVtGcSkJBpfFoXdOoV6HQP08ZR
